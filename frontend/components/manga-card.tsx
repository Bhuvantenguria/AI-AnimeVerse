...
import { BookOpen, Plus, Star, Volume2 } from "lucide-react"
...
export function MangaCard({ id, title, image, rating, genre, chapters, status, year, className }: MangaCardProps) {
