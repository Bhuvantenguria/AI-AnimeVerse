...
import { Search, Grid3X3, List, SortAsc, Play } from "lucide-react"
...
export default function AnimePage() {
  ...
  const filteredAnime = animeList.filter((anime) => {
    ...
    const matchesGenre = selectedGenres.length === 0 || selectedGenres.some((genre) => anime.genre.includes(genre))
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex items-center space-x-3 mb-8">
        ...
        <h1 className="text-4xl font-bold">Anime Library</h1>
      </div>
