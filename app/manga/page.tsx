...
import { EnhancedMangaGrid } from "@/components/enhanced-manga-grid"
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-orange-900 to-red-900">
      <div className="container mx-auto px-4 py-8">
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8">
          <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-orange-400 to-red-400 bg-clip-text text-transparent mb-4">
            Discover Manga
          </h1>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Explore thousands of manga series. Dive into incredible stories and artwork.
          </p>
        </motion.div>
        ...
        >
          <Badge
            variant="outline"
            className="cursor-pointer border-orange-500 text-orange-400 hover:bg-orange-500/10"
